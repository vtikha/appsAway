...
export APPSAWAY_IMAGES=\"icubteamcode/superbuild icubteamcode/superbuild icubteamcode/superbuild\"
export APPSAWAY_VERSIONS=\"undefined\"
export APPSAWAY_TAGS=\"undefined\"
